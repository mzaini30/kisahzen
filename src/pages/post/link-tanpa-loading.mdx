---
title: Navigasi Link di Satu Website Tanpa Loading
description: Ini adalah cara-cara supaya navigasi di web kita nggak pakai loading
date: 2022-06-05
---

Buat file `turbo.js` yang berisi:
...
Sekarang, buat `index.html` yang berisi:
...
Dan buat juga `about.html` yang berisi:
...
Maka, akan tampil isi dari `index.html` saat kita membuka `localhost:5000`. Ketika kita klik link yang menuju about, dia nggak pakai loading, tapi akan langsung tampil isinya.